$(function(){
	...
	$(document).on("click",".addCart",function(){
		var productKey = $(this).parent().parent().parent().parent().parent().parent().parent().find("input[name='productKey']").val();
		var memKey = $(this).parent().parent().parent().parent().parent().parent().parent().find("input[name='memKey']").val();
	...
	$(document).on("click",".buyNow",function(){
		...
		for(var i=0; i<cartCount1.length; i++){
			cartCount[i] = cartCount1[i].innerHTML;
			productKey[i] = $(this).parent().parent().parent().parent().parent().parent().parent().find("input[name='productKey']").val();
		}
