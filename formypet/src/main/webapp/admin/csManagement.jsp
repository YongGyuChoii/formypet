...
<%	
	...
	Vector<CsManagementBean> vlist = null;
	...
	totalRecord = csMMgr.getTotalCount(keyField, keyWord);
...
<body>
	...
	<div align="center" id = "wrap">
		...
		<table align="center" width="600" cellpadding="3" height = "600">
			<tr>
				...
				<%
					  ...
					  vlist = csMMgr.getcList(keyField, keyWord, start, end);
				
					  listSize = vlist.size();//브라우저 화면에 보여질 게시물갯수
					  
					  if (vlist.isEmpty()) {
						out.println("목록이 없습니다.");
					  ...
					  <table width="100%" cellpadding="2" cellspacing="0">
						...
						<%
							  for (int i = 0;i<numPerPage; i++) {
								if (i == listSize) break;
								CsManagementBean bean = vlist.get(i);
			...
			<tr>
				...
				<td align="right">
					<a href="javascript:csManagement()"><span class="material-symbols-outlined">home</span></a>
				</td>
			</tr>
		</table>
		<!-- 게시판 본문 끝. -->
		...
		<!-- 검색 폼 시작 -->
		<hr width="600"/>
		<form  name="searchFrm"  method="get" action="../admin/csManagement.jsp">
		<table width="600" cellpadding="4" cellspacing="0">
	 		<tr>
	  			<td align="center" valign="bottom">
	   				<select name="keyField" size="1" >
	    				<option value="memKey">번 호</option>
	    				<option value="memName">이 름</option>
	    				<option value="memId">아이디</option>
	    				<option value="delYn">삭 제</option>
	   				</select>
...
<script>
	function csManagement() {
		document.listFrm.action = "../admin/csManagement.jsp";
	...
	function read(memKey){
		document.readFrm.memKey.value=memKey;
		document.readFrm.action="../admin/read7.jsp";
		document.readFrm.submit();
	}
