...
<ul class="menu">
  ...
  <li>
    <a class="nav-link text-white" href="${pageContext.request.contextPath}/board/faq.jsp">고객센터</a>
    <ul class="depth_1">
      <li><a href="${pageContext.request.contextPath}/board/faq.jsp">FAQ</a></li>
      <li><a href="${pageContext.request.contextPath}/board/qa.jsp">문의게시판</a></li>
    </ul>
  </li>
</ul>
</div>