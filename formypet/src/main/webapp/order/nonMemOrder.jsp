 ...
 <div>
        ...
        <form method="post" accept="#">
            ...
            <table>
              ...
              <tr>
                <th>휴대전화</th>
                <td><input type="tel" name="user_tel" id="user_tel1"></td>
              </tr>
              <tr>
                <th>이메일</th>
                ...
                <tr>
                  <th>받으시는 분</th>
                  <td><input type="text" name="end_name" id="end_name"></td>
                </tr>
                <tr>
                  <th>주소</th>
                  <td><input type="text" name="addr" id="addr"> <input type="text" name="addr" id="addr"></td>
                </tr>
                <tr>
                  <th>휴대전화</th>
                  <td><input type="tel" name="end_tel" id="end_tel" ></td>
                </tr>
                <tr>
                  <th>배송 메세지</th>
